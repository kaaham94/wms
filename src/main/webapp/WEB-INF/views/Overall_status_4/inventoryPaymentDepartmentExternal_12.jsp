...
function LGORT(MANDT, WERKS){
	...
	// ajax({ 시작
	$.ajax({
		url : '/WMS/Overall_status_4/inventoryPaymentDepartmentExternal_12Select_LGORT.do',
		type: "post",
		dataType : 'json',
		data: params,
		async: false,
...
function frmScanSubmit(){
	...
	// ajax({ 시작
	$.ajax({
		url : '/WMS/Overall_status_4/inventoryPaymentDepartmentExternal_12Select_left.do',
		type: "post",
		dataType : 'json',
		data: params,
		async: false,
...
function right_table_total(){	
	...
	// ajax({ 시작
	$.ajax({
		url : '/WMS/Overall_status_4/inventoryPaymentDepartmentExternal_12Select_right_total.do',
		type: "post",
		dataType : 'json',
		data: params,
		async: false,
...
function right_table_single(insertArray){			
	//ajax 시작 
	 $.ajax({
 			url:"/WMS/Overall_status_4/inventoryPaymentDepartmentExternal_12InsertUpdate.do",
 			type:"post",
