...
@Controller
public class userAuthority_04Controller {
    Logger log = Logger.getLogger(this.getClass());
     
    @Resource(name="userAuthority_04Service")
    private userAuthority_04Service userAuthority_04Service;
     
    //page load
    @RequestMapping("/Management_of_workers_3/userAuthority_04List.do") 
	public ModelAndView userAuthority_04Select( HttpSession session, HttpServletRequest request   ) throws Exception{
    	...
    	try {
			...
			if(( StringUtils.isEmpty((String) session.getAttribute("UID")) ) == false  || (StringUtils.isEmpty((String) session.getAttribute("PWD")) == false)){	
				...
				mv = new ModelAndView("Management_of_workers_3/userAuthority_04");
    ...
    //update
    @RequestMapping(value="/Management_of_workers_3/userAuthority_04InsertUpdate.do")
    public ModelAndView userAuthority_04InsertUpdate(@RequestParam Map<String,Object> param) throws Exception{
    	...
    	try {
           ...
           //System.out.println("array:" + array);
            ...
            //9.userAuthority_04Insert 서비스에 화면에서 받아온 값 List<Map<String,Object>>객체를 인자값으로 전달 
            Map<String, Object> returnMap = userAuthority_04Service.userAuthority_04InsertUpdate(list); 
    ...
    //search
    @RequestMapping(value="/userAuthority_04/userAuthority_04Select_right.do") 
    public ModelAndView userAuthority_04Select_right (CommandMap commandMap) throws Exception{
    	...
    	String valueArr[][] = {
		  ...
		  //{"0.인자값",   							"1.초기값", 	 "2.map 키명", 			
			...
			{(String) commandMap.get("USERID"), 	"", 		"USERID"}	//2.그룹 ID
        };
		...
		List<Map<String,Object>> list = userAuthority_04Service.userAuthority_04Select_right(map); //db 리스트 출력 
    ...
    //search
    @RequestMapping(value="/userAuthority_04/userAuthority_04Select_left.do") 
    public ModelAndView userAuthority_04Select_left(CommandMap commandMap) throws Exception{
		...
		List<Map<String,Object>> list = userAuthority_04Service.userAuthority_04Select_left(map); //db 리스트 출력 
