...
@Repository("corporateByUser_02DAO")
public class corporateByUser_02Dao extends AbstractDAO{
	 
	 @SuppressWarnings("unchecked")

	 public List<Map<String, Object>> corporateByUser_02Select(Map<String, Object> map) throws Exception{
		 
		 return (List<Map<String, Object>>)selectList("corporateByUser_02.corporateByUser_02Select", map);     
	 }
	
	 public List<Map<String, Object>> corporateByUser_02Select_WERKS(Map<String, Object> map) throws Exception{
			
		 return (List<Map<String, Object>>)selectList("corporateByUser_02.corporateByUser_02Select_WERKS", map);     
	 }
	...
	public Map<String, Object> corporateByUser_02InsertUpdate(List<Map<String, Object>> list) throws Exception{
		 ...
		 try {
			 ...
			 for (Map<String, Object> map : list) {
			     ...
			     listMap = (Map<String, Object>) selectOne("corporateByUser_02.corporateByUser_02InsertUpdate", map);
			     
			     returnMessage += "\n●["+listMap.get("PROCRTNGBN")+"] 사용자ID: \""+map.get("USERID")+"\" \n"+listMap.get("PROCRTNMSG");
		...
		//1. Map, List 객체를 생성한다.
		 ...
		 try {
			 ...
			 for (Map<String, Object> map : list) {
			     ...
			     listMap = (Map<String, Object>) selectOne("corporateByUser_02.corporateByUser_02Delete", map);
