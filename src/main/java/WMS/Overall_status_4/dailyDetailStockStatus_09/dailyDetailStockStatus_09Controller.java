...
@Controller
public class dailyDetailStockStatus_09Controller {
    Logger log = Logger.getLogger(this.getClass());
     
    @Resource(name="dailyDetailStockStatus_09Service")
    private dailyDetailStockStatus_09Service dailyDetailStockStatus_09Service;
     
    //page load
    @RequestMapping("/Overall_status_4/dailyDetailStockStatus_09List.do") 
	public ModelAndView dailyDetailStockStatus_09( HttpSession session, HttpServletRequest request ) throws Exception{
    	...
    	try {
			...
			if(( StringUtils.isEmpty((String) session.getAttribute("UID")) ) == false  || (StringUtils.isEmpty((String) session.getAttribute("PWD")) == false)){	
				...
				mv = new ModelAndView("Overall_status_4/dailyDetailStockStatus_09");
    ...
    //insertupdate 
    @RequestMapping(value="/Overall_status_4/dailyDetailStockStatus_09InsertUpdate_REPRINT.do")
    public ModelAndView dailyDetailStockStatus_09InsertUpdate_REPRINT(@RequestParam Map<String,Object> param) throws Exception{
    	...
    	try {
          ...
          //9.user_01Insert 서비스에 화면에서 받아온 값 List<Map<String,Object>>객체를 인자값으로 전달 
            Map<String, Object> returnMap = dailyDetailStockStatus_09Service.dailyDetailStockStatus_09InsertUpdate_REPRINT(list); 
  ...
  //select
    @RequestMapping(value="/Overall_status_4/dailyDetailStockStatus_09Select_LGORT.do") 
    public ModelAndView dailyDetailStockStatus_09Select_LGORT (CommandMap commandMap) throws Exception{
		...
		List<Map<String,Object>> Select_LGORT = dailyDetailStockStatus_09Service.dailyDetailStockStatus_09Select_LGORT(map); //저장위 리스트 출력 
    ...
    @RequestMapping(value="/Overall_status_4/dailyDetailStockStatus_09Select_REPRINT.do") 
    public ModelAndView dailyDetailStockStatus_09Select_REPRINT (CommandMap commandMap) throws Exception{
		...
		List<Map<String,Object>> Select_REPRINT = dailyDetailStockStatus_09Service.dailyDetailStockStatus_09Select_REPRINT(map); //저장위 리스트 출력 
    ...
    @RequestMapping(value="/Overall_status_4/dailyDetailStockStatus_09Select.do") 
    public ModelAndView dailyDetailStockStatus_09Select (CommandMap commandMap, HttpSession session, Model model) throws Exception{
    	...
    	String valueArr[][] = {
    			...
    			//{"0.인자값",   					  "1.초기값", 		"2.map 키명", 			
    			  ...
    			  {(String) commandMap.get("BARNO"),      "",				"BARNO"	  },	 //바코드
    			  {(String) commandMap.get("MATNR"),      "",				"MATNR"	  },	 //자재코드
		...
		try {
			...
			List<Map<String,Object>> list = dailyDetailStockStatus_09Service.dailyDetailStockStatus_09Select(map); //db 리스트 출력
		...
		List<Map<String,Object>> Select_WERKS = dailyDetailStockStatus_09Service.dailyDetailStockStatus_09Select_WERKS(map); 	//법인 리스트 출력
		List<Map<String,Object>> Select_STATUS = dailyDetailStockStatus_09Service.dailyDetailStockStatus_09Select_STATUS(map); 	//상태 리스트 출력
		List<List<Object>> Select_LOC = dailyDetailStockStatus_09Service.dailyDetailStockStatus_09Select_LOC(map2);  //로케이션 리스트 출력
		List<Map<String,Object>> Select_PRTDEMON = dailyDetailStockStatus_09Service.dailyDetailStockStatus_09Select_PRTDEMON(map); 	//바코드 리스트 출력
	//	List<Map<String,Object>> Select_LOC = dailyDetailStockStatus_09Service.dailyDetailStockStatus_09Select_LOC(map);  //로케이션 리스트 출력
