...
@Controller
public class materialsDetail_03Controller {
    Logger log = Logger.getLogger(this.getClass());
     
    @Resource(name="materialsDetail_03Service")
    private materialsDetail_03Service materialsDetail_03Service;
     
    //page load
    @RequestMapping("/Overall_status_4/materialsDetail_03_list.do") 
	public ModelAndView materialsDetail_03Select( HttpSession session, HttpServletRequest request  ) throws Exception{
    	...
    	try {
			...
			if(( StringUtils.isEmpty((String) session.getAttribute("UID")) ) == false  || (StringUtils.isEmpty((String) session.getAttribute("PWD")) == false)){	
				...
				mv = new ModelAndView("Overall_status_4/materialsDetail_03");
  ...
  //search
    ...
    /*
    @RequestMapping(value="/Overall_status_4/materialsDetail_03Select_right_bottom.do") 
    public ModelAndView materialsDetail_03Select_right_bottom (CommandMap commandMap) throws Exception{
		...
		List<Map<String,Object>> list = materialsDetail_03Service.materialsDetail_03Select_right_bottom(map); //db 리스트 출력 
...
*/
  //select
    @RequestMapping(value="/Overall_status_4/materialsDetail_03Select_LGORT.do") 
    public ModelAndView materialsDetail_03Select_LGORT (CommandMap commandMap) throws Exception{
		...
		List<Map<String,Object>> Select_LGORT = materialsDetail_03Service.materialsDetail_03Select_LGORT(map); //저장위 리스트 출력 
    ...
    @RequestMapping(value="/Overall_status_4/materialsDetail_03Select.do") 
    public ModelAndView materialsDetail_03Select (CommandMap commandMap, HttpSession session, Model model) throws Exception{
		...
		try {
			...
			List<Map<String,Object>> list = materialsDetail_03Service.materialsDetail_03Select(map); //db 리스트 출력
		...
		List<Map<String,Object>> Select_WERKS = materialsDetail_03Service.materialsDetail_03Select_WERKS(map); //법인 리스트 출력
		List<Map<String,Object>> Select_LIFNR = materialsDetail_03Service.materialsDetail_03Select_LIFNR(map); //공급처 리스트 출력
		List<Map<String,Object>> Select_BSART = materialsDetail_03Service.materialsDetail_03Select_BSART(map); //입고유형 리스트 출력
		List<Map<String,Object>> Select_KUNNR = materialsDetail_03Service.materialsDetail_03Select_KUNNR(map); //제조사 리스트 출력
