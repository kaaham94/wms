...
@Repository("arrivalStatusByTimeZone_01DAO")
public class arrivalStatusByTimeZone_01Dao extends AbstractDAO{
	 
	 @SuppressWarnings("unchecked")

	 public List<Map<String, Object>> arrivalStatusByTimeZone_01Select_right(Map<String, Object> map) throws Exception{
		 
		 return (List<Map<String, Object>>)selectList("arrivalStatusByTimeZone_01.arrivalStatusByTimeZone_01Select_right", map);     
	 }
	 
	 public List<Map<String, Object>> arrivalStatusByTimeZone_01Select_right_bottom(Map<String, Object> map) throws Exception{
		 
		 return (List<Map<String, Object>>)selectList("arrivalStatusByTimeZone_01.arrivalStatusByTimeZone_01Select_right_bottom", map);     
	 }
	 
	 public List<Map<String, Object>> arrivalStatusByTimeZone_01Select_left(Map<String, Object> map) throws Exception{
		 
		 return (List<Map<String, Object>>)selectList("arrivalStatusByTimeZone_01.arrivalStatusByTimeZone_01Select_left", map);     
	 }
	 
	 public List<Map<String, Object>> arrivalStatusByTimeZone_01Select_WERKS(Map<String, Object> map) throws Exception{
		 
		 return (List<Map<String, Object>>)selectList("arrivalStatusByTimeZone_01.arrivalStatusByTimeZone_01Select_WERKS", map);     
	 }

	 public List<Map<String, Object>> arrivalStatusByTimeZone_01Select_LGORT(Map<String, Object> map) throws Exception{
		 
		 return (List<Map<String, Object>>)selectList("arrivalStatusByTimeZone_01.arrivalStatusByTimeZone_01Select_LGORT", map);     
	 }
	 
	 public List<Map<String, Object>> arrivalStatusByTimeZone_01Select_CUSTCD(Map<String, Object> map) throws Exception{
		 
		 return (List<Map<String, Object>>)selectList("arrivalStatusByTimeZone_01.arrivalStatusByTimeZone_01Select_CUSTCD", map);     
	 }
	 
	 public Map<String, Object> arrivalStatusByTimeZone_01InsertUpdate(List<Map<String, Object>> list) throws Exception{
		...
		//1. Map 객체를 생성한다. 
		 ...
		 try {
			 ...
			 for (Map<String, Object> map : list) {
			      ...
			      validation = (Integer) selectOne("arrivalStatusByTimeZone_01.arrivalStatusByTimeZone_01InsertUpdateCheck_IPADDR", map);
			...
			//4.1 결과실행 (검증 합격)
			 if(result == true) {
				// System.out.println("DAO list:"+list);
				 ...
				 returnValue = (Integer)insert("arrivalStatusByTimeZone_01.arrivalStatusByTimeZone_01InsertUpdate", listMap);
