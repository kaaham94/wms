...
@Controller
public class presentStatusOfShipment_04Controller {
    Logger log = Logger.getLogger(this.getClass());
     
    @Resource(name="presentStatusOfShipment_04Service")
    private presentStatusOfShipment_04Service presentStatusOfShipment_04Service;
     
    //page load
    @RequestMapping("/Overall_status_4/presentStatusOfShipment_04_list.do") 
	public ModelAndView presentStatusOfShipment_04Select( HttpSession session, HttpServletRequest request  ) throws Exception{
    	...
    	try {
			...
			if(( StringUtils.isEmpty((String) session.getAttribute("UID")) ) == false  || (StringUtils.isEmpty((String) session.getAttribute("PWD")) == false)){	
				...
				mv = new ModelAndView("Overall_status_4/presentStatusOfShipment_04");
  ...
  //search
    ...
    /*
    @RequestMapping(value="/Overall_status_4/presentStatusOfShipment_04Select_right_bottom.do") 
    public ModelAndView presentStatusOfShipment_04Select_right_bottom (CommandMap commandMap) throws Exception{
		...
		List<Map<String,Object>> list = presentStatusOfShipment_04Service.presentStatusOfShipment_04Select_right_bottom(map); //db 리스트 출력 
...
*/
  //select
    @RequestMapping(value="/Overall_status_4/presentStatusOfShipment_04Select_LGORT.do") 
    public ModelAndView presentStatusOfShipment_04Select_LGORT (CommandMap commandMap) throws Exception{
		...
		List<Map<String,Object>> Select_LGORT = presentStatusOfShipment_04Service.presentStatusOfShipment_04Select_LGORT(map); //저장위 리스트 출력 
    ...
    @RequestMapping(value="/Overall_status_4/presentStatusOfShipment_04Select.do") 
    public ModelAndView presentStatusOfShipment_04Select (CommandMap commandMap, HttpSession session, Model model) throws Exception{
		...
		try {
			...
			List<Map<String,Object>> list = presentStatusOfShipment_04Service.presentStatusOfShipment_04Select(map); //db 리스트 출력
		...
		List<Map<String,Object>> Select_WERKS = presentStatusOfShipment_04Service.presentStatusOfShipment_04Select_WERKS(map); 	//법인 리스트 출력
		List<Map<String,Object>> Select_CUST = presentStatusOfShipment_04Service.presentStatusOfShipment_04Select_CUST(map); 	//고객 리스트 출력
		List<Map<String,Object>> Select_KUNNR = presentStatusOfShipment_04Service.presentStatusOfShipment_04Select_KUNNR(map);  //제조사 리스트 출력
